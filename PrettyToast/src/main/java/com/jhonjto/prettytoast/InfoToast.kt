    ...
    companion object {
        ...
        fun infoToast(context: Activity, message: String, position: Int) {
            ...
            val layout = layoutInflater.inflate(
                ...
                (context).findViewById(R.id.info_toast)
            )
            ...
            val drawable = ContextCompat.getDrawable(context, R.drawable.info_bg)
            drawable?.colorFilter = PorterDuffColorFilter(
                ContextCompat.getColor(context, R.color.info_toast_color),
